                ...
                <tbody>
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            ...
                            <button type="button" class="focus:outline-none text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-2 mb-2 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">Eliminar</button>
                        </td>
                    </tr>
